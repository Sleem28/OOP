...
import HomeWork5.Base.AbstractClasses.AComplexOperation;

public class ComplexSubstractionOperation extends AComplexOperation {
    public ComplexSubstractionOperation(CNum firstCnum, CNum secondCnum) {
